//! Native connector ABI for Elasticsearch.
//!
...
const ENGINE: &str = "elasticsearch";
...
const HEALTH_RESPONSE_JSON: &str =
    r#"{"ok":true,"engine":"elasticsearch","abiVersion":1,"driverLinked":false}"#;
const DESCRIBE_RESPONSE_JSON: &str = concat!(
    r#"{"ok":true,"engine":"elasticsearch","abiVersion":1,"driverLinked":false,"manifest":"#,
